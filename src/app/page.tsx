  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-12 ">
        {/* Hero Banner with Image Carousels */}
      ...
      <footer className="bg-muted mt-8 py-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              <h3 className="font-semibold mb-2">Kurumsal Bilgiler</h3>
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-sm text-muted-foreground hover:text-foreground">Sürdürülebilirlik</a></li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold mb-2">Yardım</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-sm text-muted-foreground hover:text-foreground">Müşteri Hizmetleri</a></li>
                <li><a href="#" className="text-sm text-muted-foreground hover:text-foreground">Hesabım</a></li>
