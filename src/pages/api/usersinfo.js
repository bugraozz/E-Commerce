...
//                 'INSERT INTO "Users" (adress, phone) VALUES ($1, $2) RETURNING id, adress, phone',
//                 [adress, phone]
//             );
...
//         const { id, Username, adress, phone, email } = req.body;
        
//         try {
//             const result = await db.query(
//                 'UPDATE "Users" SET "Username" = $1, adress = $2, phone = $3, email = $4 WHERE id = $5 RETURNING id, Username, email, adress, phone',
//                 [Username, adress, phone, email, id]
//             );
